  ...
  <div class="container-fluid">
    ...
    <div class="row justify-content-center">
      ...
      <div class="text-center p-0 mb-2">
        ...
        <div class="card px-0 pt-1 pb-0 mt-3  mr-auto mb-3 w-75">
          ...
          <form id="msform" method="POST" enctype="multipart/form-data" novalidate class="p-3 mt-0 was-validated">
            ...
            <fieldset>
              <div class="form-card">
                ...
                <div>
                  ...
                  <div class="mt-4 mb-4">
                    <label class="form-label" for="idea-title" style="font-size: 1.3rem;color: black;">Title of the
                      idea/product *</label>
                  ...
                  <div class="mb-4">
                    <label class="form-label" for="idea-sub-title" style="font-size: 1.3rem;color: black;">Subtitle
                      *</label>
                  ...
                  <div class="mb-4">
                    <label class="form-label" for="idea-short-desc" style="font-size: 1.3rem;color: black;">Short
                      description *</label>
                  ...
                  <div class="mb-4">
                    <label for="idea-sector" class="form-label" style="font-size: 1.3rem;color: black;">Primary sector
                      of your innovation *</label>
                  ...
                  <div class="mb-4">
                    <label class="form-label" for="idea-solution" style="font-size: 1.3rem;color: black;">Solution
                      *</label>
                  ...
                  <div class="mb-4">
                    <label class="form-label" for="idea-tech-desc" style="font-size: 1.3rem;color: black;">Tech
                      description *</label>
            ...
            <fieldset>
              <div class="form-card">
                ...
                <div>
                  <div class="mt-4 mb-4">
                    <label for="idea-file" class="form-label" style="font-size: 1.3rem;color: black;">Idea ppt or pdf
                      *</label>
                    <input class="form-control" name="idea-file" type="file" id="idea-file" required>
                  </div>
                  <div class="mb-4">
                    <label for="idea-image1" class="form-label" style="font-size: 1.3rem;color: black;">Image 1
                      *</label>
                    <input class="form-control" name="idea-image1" type="file" id="idea-image1" required>
                  </div>
                  <div class="mb-4">
                    <label for="idea-image2" class="form-label" style="font-size: 1.3rem;color: black;">Image 2
                      *</label>
                    <input class="form-control" name="idea-image2" type="file" id="idea-image2" required>
                  </div>
                  <div class="mb-4">
                    <label for="idea-image3" class="form-label" style="font-size: 1.3rem;color: black;">Image 3
                      *</label>
