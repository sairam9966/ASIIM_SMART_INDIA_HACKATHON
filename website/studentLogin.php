<div class=" tab-pane fade show active" id="pills-stud-login" role="tabpanel" aria-labelledby="tab-login">
  <form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST" enctype="multipart/form-data" novalidate
    class="needs-validation" style="display: flex; justify-content:center;">
    ...
    <div class=" w-50">
      ...
      <!-- Submit button -->
      <button type="submit" name="studLogin" class="btn btn-primary btn-block mb-4"
        style="background: linear-gradient(90deg, rgba(55,59,68,1) 0%, rgba(66,134,244,1) 100%); font-size:1.5rem;">Login</button>
...
<?php
            ...
            ?>
<script>
swal("Invalid Credentials!", "Invalid password", "warning");
</script>
<?php
        }
