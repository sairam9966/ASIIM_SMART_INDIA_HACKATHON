  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div>
          <a class="btn  btn-outline-danger btn-md" href="../student/student-logout.php"
            style="color:white;font-size:1.2rem;" type="button">Logout</a>
        </div>
      </div>
    </div>
  </nav>
              ...
              <div class="meta-txt">
                ...
                <div class="view-file">
                  <a href=" <?php echo $file; ?> " target="_blank"
                    class="btn btn-round btn-secondary btn-block btn-transparent">
